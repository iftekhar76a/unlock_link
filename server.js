...
// ✅ আপনার দেওয়া MongoDB URL (সরাসরি ব্যবহার করা হয়েছে, তবে environment variable ব্যবহার করা ভালো)
const MONGODB_URI = 'mongodb+srv://zacobmacrob06_db_user:iftekhar.202059@cluster0.v9ozz6k.mongodb.net/unlock_system?retryWrites=true&w=majority&appName=Cluster0';
...
async function initAdmin() {
  ...
  if (!admin) {
    const hashedPassword = await bcrypt.hash('12312345', 10); // ✅ আপনার দেওয়া পাসওয়ার্ড
